...
<div class="menuwrapper">
	<ul id="tabnav">
		...
		<li class="tab2">
			<a href="{$my_pligg_base}/module.php?module=simple_messaging&view=sent" {if $modulepage eq "simple_messaging_sentbox" ||  $modulepage eq "viewsentmsg"}style="background:#fff;border-bottom:1px solid #fff;"{/if}>
		...
		{if $Allow_Friends neq "0"}	 
			<li class="tab3">
				<a href="{$user_url_friends}">
					<img src="{$my_pligg_base}/templates/{$the_template}/images/friends.png" alt="" align="absmiddle"/>
			...
			<li class="tab4">
				<a href="{$user_url_friends2}">
					<img src="{$my_pligg_base}/templates/{$the_template}/images/friends2.png" alt="" align="absmiddle"/>
