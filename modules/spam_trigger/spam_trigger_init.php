...
if(defined('mnminclude')){
	...
	if( do_we_load_module() ) {
		if(is_object($main_smarty)){
			module_add_action_tpl('tpl_pligg_admin_body_start', spam_trigger_tpl_path . 'spam_trigger_notify.tpl');
			module_add_action_tpl('tpl_pligg_head_end', spam_trigger_tpl_path . 'spam_trigger_css.tpl');
			include_once(mnmmodules . 'spam_trigger/spam_trigger_main.php');
		}
	...
	if( do_we_load_module() ) {		
		module_add_action('after_comment_submit', 'spam_trigger_comment_submit','');
