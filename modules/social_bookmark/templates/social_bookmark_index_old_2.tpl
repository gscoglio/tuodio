...
&nbsp;&nbsp;<a title="submit '{$title_short}' to twitter" href="http://twitter.com/home?status={$enc_url}&t={$title_short}"><img src="{$my_base_url}{$my_pligg_base}/modules/social_bookmark/images/twitter.png" border="0" alt="submit '{$title_short}' to twitter" /></a>
<hr />
