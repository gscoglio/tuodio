<div id="filter">
		...
		<span>{#PLIGG_Visual_Breadcrumb_Unpublished#}</span>
		<a href="{$URL_comments}">{#PLIGG_Visual_Breadcrumb_Comments#}</a>
		<a href="{$URL_unpublished}" class="navbut4">{#PLIGG_Visual_Breadcrumb_Unpublished_Tab#}</a>
...
{section name=live_item loop=$live_items}
	...
	<div class="live2-item">
		...
		<div class="live2-ts"><a href="{$URL_queuedcategory, $live_items[live_item].link_category}">{$live_items[live_item].link_category}</a></div>
