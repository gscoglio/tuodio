{if $isAdmin eq 1}
	{php}
		...
		if($canIhaveAccess == 1)
		{
			...
			echo "<fieldset><legend><img src=".my_pligg_base."/templates/".The_Template."/images/manage_backup.png align=absmiddle /> ";{/php}{#PLIGG_Visual_Header_AdminPanel_4#}{php}echo "</legend>";
			echo '<h3>';{/php}{#PLIGG_Visual_View_Backup#}{php}echo':</h3><img src="'.my_pligg_base.'/templates/'.The_Template.'/images/backup_files.png" align="absmiddle" /> <a href = "?dobackup=files">';{/php}{#PLIGG_Visual_View_Backup_Files#}{php} echo'</a><br>';
			echo '<img src="'.my_pligg_base.'/templates/'.The_Template.'/images/backup_avatars.png" align="absmiddle" /> <a href = "?dobackup=avatars">';{/php}{#PLIGG_Visual_View_Backup_Avatars#}{php}echo'</a><br>';
			echo '<img src="'.my_pligg_base.'/templates/'.The_Template.'/images/backup_db.png" align="absmiddle" /> <a href = "?dobackup=database">';{/php}{#PLIGG_Visual_View_Backup_Database#}{php}echo'</a><br><br>';
			echo "<h4 style='border:none'>";{/php}{#PLIGG_Visual_View_Backup_Previous#}{php}echo"</h4>";
			echo '<img src="'.my_pligg_base.'/templates/'.The_Template.'/images/backup_remove.png" align="absmiddle" /> <a href = "?dobackup=clearall">';{/php}{#PLIGG_Visual_View_Backup_Remove#}{php}echo'</a><hr><br>';
