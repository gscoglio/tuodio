...
<fieldset><legend>View User: {$userdata[nr].user_login} <img src="{$userdata[nr].Avatar}" align="absmiddle"/></legend>
	<table style="border:none">
		...
		<tr><td><img src="{$my_pligg_base}/templates/{$the_template}/images/user_links.png" align="absmiddle"/> <a href="?mode=viewlinks&user={$userdata[nr].user_login}">{#PLIGG_Visual_View_User_Sub_Links#}</a></td><td>{$linkcount} Total</td></tr>
		<tr><td><img src="{$my_pligg_base}/templates/{$the_template}/images/user_comments.png" align="absmiddle"/> <a href="?mode=viewcomments&user={$userdata[nr].user_login}">{#PLIGG_Visual_View_User_Sub_Comments#}</a></td><td>{$commentcount} Total</td></tr>
	</table>	
<hr/>
