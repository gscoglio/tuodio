 ...
 <fieldset>
	<table width="500">
			...
			<tr><td valign="top" rowspan="2">
				...
				<img src="{$my_pligg_base}/templates/admin/images/manage_config.gif" align="absmiddle"/> <a href="{$my_pligg_base}/admin/admin_optimize_database.php" rel="width:400,height:300" class="mb" >{#PLIGG_Visual_AdminPanel_Optimize#}</a><br/>
				<br />
