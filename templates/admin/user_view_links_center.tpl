...
<tr><th>{#PLIGG_Visual_View_Links_Status#}</th><th>{#PLIGG_Visual_View_Links_New_Window#}</th><th><center>Publish</center></th><th><center>Queued</center></th><th><center>Discard</center></th></tr>
	...
	<tr>
		<td width="100px">{$links[nr].link_status}</td>
		<td><a href = "{$my_pligg_base}/story.php?title={$links[nr].link_title_url}" target="_blank">{$links[nr].link_title}</a></td>
		<td width="60px"><center><input type="radio" name="link[{$links[nr].link_id}]" id="link-{$links[nr].link_id}" value="publish"></center></td>
		<td width="60px"><center><input type="radio" name="link[{$links[nr].link_id}]" id="link-{$links[nr].link_id}" value="queued"></center></td>
		<td width="60px"><center><input type="radio" name="link[{$links[nr].link_id}]" id="link-{$links[nr].link_id}" value="discard"></center></td>
	</tr>	
	{/section}
</table>
<br/>
