...
<fieldset><legend><img src="{$my_pligg_base}/templates/{$the_template}/images/user_edit.png" align="absmiddle" /> {#PLIGG_Visual_Breadcrumb_Edit_User#}: {$userdata[nr].user_login}</legend>
