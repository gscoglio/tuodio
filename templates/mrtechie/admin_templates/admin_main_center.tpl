{if $amIgod eq 1}
 <fieldset><legend>{#PLIGG_Visual_Header_AdminPanel_Main#}</legend>
	<table style="border:none">
			...
			<tr><td>
				<img src="{$my_pligg_base}/templates/{$the_template}/images/cart.png" align="absmiddle"/> <a href="http://www.pligg.com/pro/" target="_blank">{#PLIGG_Visual_Header_AdminPanel_Shop#}</a><br/>
