	...
	<div class="storyfooter">
		...
		<span id="ls_comments_url-{$link_shakebox_index}">
			{if $story_comment_count eq 0}
				<span id="linksummaryDiscuss"><a href="{$story_url}#discuss" class="comments"> &raquo; {#PLIGG_MiscWords_Discuss#}</a>&nbsp;</span>
			{/if}
			{if $story_comment_count eq 1}
				<span id="linksummaryHasComment"><a href="{$story_url}#comments" class="comments2"> &raquo; {$story_comment_count} {#PLIGG_MiscWords_Comment#}</a>&nbsp;</span>
			{/if}
			{if $story_comment_count gt 1}
				<span id="linksummaryHasComment"><a href="{$story_url}#comments" class="comments2"> &raquo; {$story_comment_count} {#PLIGG_MiscWords_Comments#}</a>&nbsp;</span>
			{/if}
		</span> 
