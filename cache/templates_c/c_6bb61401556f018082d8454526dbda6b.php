<?php require_once('/home/gscoglio/tuodio.com.ar/plugins/function.checkForCss.php'); $this->register_function("checkForCss", "tpl_function_checkForCss");  require_once('/home/gscoglio/tuodio.com.ar/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2011-07-06 06:23:42 PDT */ ?>
...
/templates/admin/css/ie6.css" type="text/css" media="all" /><![endif]-->
	...
	<?php if ($this->_vars['pagename'] == "admin_links" || $this->_vars['pagename'] == "admin_users" || $this->_vars['pagename'] == "admin_comments" || $this->_vars['pagename'] == "admin_page" || $this->_vars['pagename'] == "admin_group" || $this->_vars['pagename'] == "admin_index"): ?>
