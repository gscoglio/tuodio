<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2011-07-06 06:23:44 PDT */  if ($this->_vars['amIgod'] == 1): ?>
 <fieldset>
	<table width="500">
...
"><?php echo $this->_confs['PLIGG_Visual_AdminPanel_Delete_Cache']; ?>
				...
				<img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/admin/images/manage_config.gif" align="absmiddle"/> <a href="<?php echo $this->_vars['my_pligg_base']; ?>
/admin/admin_optimize_database.php" rel="width:400,height:300" class="mb" ><?php echo $this->_confs['PLIGG_Visual_AdminPanel_Optimize']; ?>
</a><br/>
				<br />
