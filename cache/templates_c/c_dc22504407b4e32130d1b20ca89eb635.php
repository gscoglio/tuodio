<?php require_once('/home/gscoglio/tuodio.com.ar/plugins/modifier.sanitize.php'); $this->register_modifier("sanitize", "tpl_modifier_sanitize");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2011-07-17 15:00:19 PDT */ ?>
...
?>
	<tr>
		<td width="80px"><?php echo $this->_vars['template_stories'][$this->_sections['id']['index']]['link_status']; ?>
</td>
...
" ><?php echo $this->_vars['template_stories'][$this->_sections['id']['index']]['link_title']; ?>
		...
		<td width="60px"><center><input type="radio" name="link[<?php echo $this->_vars['template_stories'][$this->_sections['id']['index']]['link_id']; ?>
...
" value="discard"></center></td>
		<?php if ($this->_vars['template_stories'][$this->_sections['id']['index']]['link_status'] == "page"): ?>
                <td><center><a href='<?php echo $this->_vars['my_pligg_base']; ?>
/admin/edit_page.php?link_id=<?php echo $this->_vars['template_stories'][$this->_sections['id']['index']]['link_id']; ?>
' rel="width:800,height:700" class="mb"><?php echo $this->_confs['PLIGG_Visual_AdminPanel_Page_Edit']; ?>
</center></td>
                 <?php else: ?>
                 <td width="70px"><center><a href='<?php echo $this->_vars['my_pligg_base']; ?>
...
<p align="right"><input type="submit" name="submit" value="<?php echo $this->_confs['PLIGG_Visual_Change_Link_Status']; ?>
" class="log2" /></p>
</form>
