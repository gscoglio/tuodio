<?php require_once('/www/minutodedescuento.com.ar/tuodio/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2011-07-03 19:37:15 GMT+3 */  if ($this->_vars['pagename'] != "story" && $this->_vars['pagename'] != "submit" && $this->_vars['pagename'] != "user"): ?>
...
#discuss" class="comments"> &raquo; <?php echo $this->_confs['PLIGG_MiscWords_Discuss']; ?>
</a>&nbsp;</span>
			<?php endif; ?>
			<?php if ($this->_vars['story_comment_count'] == 1): ?>
				<span id="linksummaryHasComment"><a href="<?php echo $this->_vars['story_url']; ?>
#comments" class="comments2"> &raquo; <?php echo $this->_vars['story_comment_count']; ?>
