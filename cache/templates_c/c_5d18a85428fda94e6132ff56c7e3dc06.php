<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2011-07-06 07:08:16 PDT */  echo tpl_function_checkActionsTpl(array('location' => "tpl_pligg_profile_start"), $this);?>
 ...
 <?php echo $this->_confs['PLIGG_Visual_User_Profile_Remove_Friend_2']; ?>
				...
				<?php else: ?>
	   				...
	   				<?php if ($this->_vars['user_authenticated'] == true): ?>
						...
						<img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/<?php echo $this->_vars['the_template']; ?>
/images/user_add.png" align="absmiddle"/>
...
"><?php echo $this->_confs['PLIGG_Visual_User_Profile_View_Friends_2']; ?>
	...
	<?php if ($this->_vars['friends']): ?>
	  	<table><th width="250px"><?php echo $this->_confs['PLIGG_Visual_User_Profile_Username']; ?>
</th><th width="60px"><?php echo $this->_confs['PLIGG_Visual_User_Profile_Message']; ?>
</th><th width="60px"><?php echo $this->_confs['PLIGG_Visual_User_Profile_Remove_Friend']; ?>
</th>
...
"><?php echo $this->_vars['myfriend']['user_login']; ?>
			...
			<td align="center"><a href="<?php echo $this->_vars['my_pligg_base']; ?>
...
"><img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/<?php echo $this->_vars['the_template']; ?>
/images/user_message.png" border="0"></a></td>
			<td align="center"><a href = "<?php echo $this->_vars['removeURL']; ?>
"><img src="<?php echo $this->_vars['my_pligg_base']; ?>
/templates/<?php echo $this->_vars['the_template']; ?>
/images/user_delete.png" border=0></a></td>
			</tr>
		<?php endforeach; endif; ?>
		</table>
	<?php else: ?>
		<br /><br /><center><h2><?php echo $this->_confs['PLIGG_Visual_User_Profile_No_Friends']; ?>
</h2></center>
	<?php endif;  endif; ?>
...
"><?php echo $this->_confs['PLIGG_Visual_User_Profile_View_Friends']; ?>
	...
	<?php if ($this->_vars['friends']): ?>
	  	<table><th width="250px"><?php echo $this->_confs['PLIGG_Visual_User_Profile_Username']; ?>
</th><th width="500px"><?php echo $this->_confs['PLIGG_Visual_User_Profile_Message']; ?>
</th>
		<?php if (count((array)$this->_vars['friends'])): foreach ((array)$this->_vars['friends'] as $this->_vars['myfriend']): ?>
			<?php 
				$this->_vars['friend_avatar'] = get_avatar('small', $this->_vars['myfriend']['user_avatar_source'], $this->_vars['myfriend']['user_login'], $this->_vars['myfriend']['user_email']);
...
/images/user_message.png" border="0"></a></td>
	...
	<?php else: ?>
		<br /><br /><center><h2><?php echo $this->_confs['PLIGG_Visual_User_Profile_No_Friends_2']; ?>
</h2>
	<?php endif;  endif; ?>
...
"><?php echo $this->_confs['PLIGG_Visual_User_Profile_View_Friends_2']; ?>
	...
	<br /><center>
	<h2><?php echo $this->_confs['PLIGG_Visual_User_Profile_Friend_Removed']; ?>
</h2>
	</center>
<?php endif; ?>
...
"><?php echo $this->_confs['PLIGG_Visual_User_Profile_View_Friends_2']; ?>
	...
	<br /><center>
	<h2><?php echo $this->_confs['PLIGG_Visual_User_Profile_Friend_Added']; ?>
</h2>
	</center>
<?php endif; ?>
...
"> <?php echo $this->_vars['myfriend']['user_login']; ?>
			...
			<?php else: ?>
				<br /><?php echo $this->_confs['PLIGG_Visual_User_Profile_No_Friends']; ?>
