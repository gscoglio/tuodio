...
if(isset($_GET['category'])){
	$main_smarty->assign('index_url_recent', getmyurl('upcoming_sort', 'recent', sanitize($_GET['category'],2)));
	...
	$main_smarty->assign('index_url_recent', getmyurl('upcoming_sort', 'recent'));
