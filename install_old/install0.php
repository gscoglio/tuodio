...
if($_GET['language'] == ''){
	$url = 'http://www.pligg.com/languages/check/getLanguageList.php?version=103';
	...
	if($language != 'local'){
	    $url = 'http://www.pligg.com/languages/check/getLanguageFile.php?type=installer&version=103&language=' . $language;
	    $r = new CD_HTTPRequest($url);
	    $data = $r->DownloadToString();
